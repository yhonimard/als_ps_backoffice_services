...
import { API_CREATE_PRODUCT, API_CREATE_PRODUCT_CATEGORY, API_GET_PRODUCT, API_GET_PRODUCT_CATEGORY } from "../fixtures/api"
...
routes.route(API_CREATE_PRODUCT_CATEGORY).post(jwtVerify, controller.createCategory)
